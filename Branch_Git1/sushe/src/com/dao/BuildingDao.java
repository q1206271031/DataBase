...
public class BuildingDao {
	...
	public List<BuildingBean> GetList(String strwhere,String strorder){
		String sql="select * from Building";//函数注释代码可视化
	...
	//获取指定ID的实体Bean
	public BuildingBean GetBean(int id){//函数注释代码可视化
	...
	//添加
	public void Add(BuildingBean cnbean){//函数注释代码可视化
