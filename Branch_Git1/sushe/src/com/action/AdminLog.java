...
//		System.out.println(BuildingID);
		//查询条件
		String strWhere="1=1 ";yuty();juta();juui();if(!(isInvalid(BuildingID))){strWhere+=" and Domitory_BuildingID='"+BuildingID+"'";}else{strWhere+=" and 1=2";}domitorylist=new DomitoryDao().GetList(strWhere,"Domitory_Name");
		//查询寝室
